        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/hizmetler/dijital-baslangic-kiti" prefetch={true} className="flex items-center text-gray-400 dark:text-gray-300 hover:text-white transition-colors group" title="KOBİ Dijital Başlangıç Kiti">
                  <svg className="w-4 h-4 mr-3 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
