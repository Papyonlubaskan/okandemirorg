...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    const variants = {
      ...
      secondary: "bg-gray-600 hover:bg-gray-700 text-white focus:ring-gray-300 shadow-lg hover:shadow-xl",
      outline: "border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white focus:ring-blue-300",
      ghost: "text-gray-600 hover:bg-gray-100 hover:text-gray-900 focus:ring-gray-300",
      destructive: "bg-red-600 hover:bg-red-700 text-white focus:ring-red-300 shadow-lg hover:shadow-xl"
    }
