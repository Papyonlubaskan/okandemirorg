            ...
            <div className="space-y-10 lg:space-y-16 flex flex-col justify-between min-h-[600px] lg:min-h-[800px] py-8 lg:py-12">
              <div className="space-y-8 lg:space-y-12 flex-1 flex flex-col justify-center">
                <h1 className="hero-title leading-tight text-center" style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif", fontWeight: 'bold' }}>
                  <span className="block text-white mb-6 lg:mb-8" style={{ fontSize: '64px', fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif", fontWeight: 'bold' }}>Sizin İçin Çalışmaya Hazırım!</span>
                  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500" style={{ fontSize: '64px', fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif", fontWeight: 'bold' }}>
                ...
                <p className="hero-description text-gray-100 leading-tight mb-12 font-black" style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif", fontSize: '24px', fontWeight: '500' }}>
                  Doğru strateji + Doğru Araçlar = Gerçek Sonuçlar. Dijital pazarlama, dijital dönüşüm, sosyal medya yönetimi, SEO, Google Ads, Meta Business sistem kurulumu ve yüksek dönüşüm odaklı web tasarımı ile daha fazla trafik, daha çok lead, daha yüksek satış için yanınızdayım! Sizin için en iyisini gerçekleştirelim.
                </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center text-center transform transition-all duration-500 hover:scale-105 hover:shadow-2xl">
              ...
              <ul className="text-left text-gray-600 space-y-2 mb-8 w-full">
                <li className="flex items-start text-lg">
                  <svg className="w-5 h-5 text-green-500 mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
