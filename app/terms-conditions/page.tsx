  ...
  return (
    <main className="min-h-screen bg-gray-50 py-20">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-4xl font-black text-gray-900 mb-8">Kullanım Şartları</h1>
        ...
        <div className="prose max-w-none">
          ...
          <h2 className="text-2xl font-black text-gray-900 mb-4">Hizmet Kullanımı</h2>
