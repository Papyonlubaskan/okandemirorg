        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <h3 className="text-2xl font-black text-gray-900 mb-4">Kişisel Web Siteleri</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <h3 className="text-2xl font-black text-gray-900 mb-4">E-ticaret Çözümleri</h3>
              <p className="text-gray-600 mb-6">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <h3 className="text-2xl font-black text-gray-900 mb-4">Özel Tasarım & Geliştirme</h3>
              <p className="text-gray-600 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <h3 className="text-2xl font-black text-gray-900 mb-4">WordPress Avantajları</h3>
              <p className="text-gray-600 mb-6">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <h3 className="text-2xl font-black text-gray-900 mb-4">Performans Optimizasyonu</h3>
              <p className="text-gray-600 mb-6">
          ...
          <div className="bg-white rounded-3xl p-12 shadow-lg">
            <h2 className="text-3xl font-black text-center text-gray-900 mb-12">WordPress Geliştirme Sürecimiz</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">İhtiyaçlarınızı analiz edip plan yapıyoruz</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Görsel tasarım ve kullanıcı deneyimi oluşturuyoruz</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">WordPress ile kodlama ve entegrasyon yapıyoruz</p>
              </div>
              <div className="text-center">
                ...
                <h3 className="text-xl font-black text-gray-900 mb-2">Test & Yayın</h3>
                <p className="text-gray-600">Test edip canlıya alıyoruz</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 bg-gradient-to-r from-blue-50 to-blue-50 rounded-3xl p-12">
            <h2 className="text-3xl font-black text-center text-gray-900 mb-12">Sürekli Destek ve Bakım</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-6 shadow-lg text-center">
                ...
                <p className="text-gray-600">Herhangi bir sorun için 7/24 teknik destek</p>
              </div>
              <div className="bg-white rounded-2xl p-6 shadow-lg text-center">
                <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="text-xl font-black text-gray-900 mb-2">Güncelleme</h3>
                <p className="text-gray-600">WordPress ve eklenti güncellemeleri</p>
              </div>
              <div className="bg-white rounded-2xl p-6 shadow-lg text-center">
                ...
                <h3 className="text-xl font-black text-gray-900 mb-2">Güvenlik</h3>
                <p className="text-gray-600">Güvenlik yamaları ve koruma</p>
              </div>
            </div>
          </div>
        </div>
