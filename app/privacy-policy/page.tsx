    ...
    <main className="min-h-screen bg-gray-50 py-20">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="prose max-w-none">
          ...
          <h2 className="text-2xl font-black text-gray-900 mb-4">Toplanan Bilgiler</h2>
          ...
          <h2 className="text-2xl font-black text-gray-900 mb-4">Bilgilerin Kullanımı</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-2xl font-black text-gray-900 mb-4">Bilgi Güvenliği</h2>
