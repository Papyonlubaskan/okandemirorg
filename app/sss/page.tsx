                ...
                <div className="bg-gradient-to-r from-blue-600 to-purple-600 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-8 lg:p-12">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <a 
                      ...
                      className="inline-flex items-center bg-white dark:bg-gray-700 text-blue-600 dark:text-white px-6 py-3 rounded-full font-black hover:bg-blue-50 dark:hover:bg-gray-600 transition-colors"
                    >
